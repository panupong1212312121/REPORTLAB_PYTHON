...
path_output = r'output/tutorial26.pdf'

pdf=SimpleDocTemplate(path_output)
flow_obj=[]
styles=getSampleStyleSheet()
data=[[str(x) for x in range (1,7)],
...
tstyle=TableStyle([("BOX",(0,0),(-1,-1),5,colors.red), # ความหนาเส้นขอบของเส้นที่คลอบคลุมข้อมูลตั้งแต่ พิกัด (0,0) ถึง (-1,-1) = 5
